...
[source,ruby]
----
The 3D model group recommends that a new CDB standard adaopts the latest version of OpenFlight, 
...
The storing of 3D models can be either in files and folders or inside a Geopackage. 
...
Some consideration should be maded to ensure all existing GSModelDescriptor information is migrated into this file.
