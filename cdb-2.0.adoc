...
:title: <CDB 2.0 Conceptual Model with Prototyping Examples>:

:initiative_short_name: CDB 2.0 Study
...
:docReference: <Something - could be OGC XX-XXX>
...
:editor: Tracey Birch, David Graham, Carl Reed

// *****************************************************************************
// Proposed working group for review (e.g. Architecture DWG, WCS SWG)
// *****************************************************************************

:workingGroup: SWG/DWG for Review: CDB Standards Working Group
...
include::5-design-goals.adoc[]

include::6-Models.adoc[]

include::7-Attribution.adoc[]

include::8-Vectors-GeoPackage.adoc[]

include::9-3D.adoc[]

include::10-top-level-metadata.adoc[]

include::11-tiling-coverages.adoc[]
