...
Versioning is used so that background level data, including things like worlwidee NAV data, can be maintained and distributed on a different schedule than other more localized data.
