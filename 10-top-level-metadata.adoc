...
The following are the recommendations for metadata and provenance in CDB-X. Please jote that all Spring participants agreed that metadata including provenance is a critical requirement for the CDB-X Standard. They also agreed that some elements shall be mandatory.
