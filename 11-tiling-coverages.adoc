...
These were first described as separate experiments on the https://github.com/sofwerx/cdb2-concept/wiki[CDB X concept wiki], but here the combined final results of producing a prototype
