...
http://maps.ecere.com/CDBX/X2/SanDiegoLayers/ (11.3 GB)
...
http://maps.ecere.com/CDBX/X2/SanDiegoOnePackage/

Please contact me if you are interested in this version, or if you have space available where we could host a 9.3 GB .7z file for this.
...
https://maps.ecere.com/CDBX/X2/SanDiegoLayers/cdb.json[Top-level _cdb.json_ index]

https://maps.ecere.com/CDBX/X2/SanDiegoLayers/Elevation/[Elevation]

Imagery:

https://maps.ecere.com/CDBX/X2/SanDiegoLayers/BlueMarble/[Full resolution global coverage (for one particular month) of the NASA Visible Earth Blue Marble]

https://maps.ecere.com/CDBX/X2/SanDiegoLayers/ImageryL7/[Medium resolution imagery]

https://maps.ecere.com/CDBX/X2/SanDiegoLayers/ImageryL9/[High resolution imagery]

Vector data (tiled, using Mapbox Vector Tiles):

https://maps.ecere.com/CDBX/X2/SanDiegoLayers/ImageryL9/[Hydrography]

https://maps.ecere.com/CDBX/X2/SanDiegoLayers/Roads.gpkg[Roads]
...
https://maps.ecere.com/CDBX/X2/SanDiegoLayers/Buildings.gpkg[Buildings]

https://maps.ecere.com/CDBX/X2/SanDiegoLayers/Trees.gpkg[Trees]
...
This one GeoPackage containing the whole San Diego CDB data (excluding Blue Marble and batched 3D models):

[Complete San Diego CDB X - _cdb.json_ index]()

[Complete San Diego CDB X - GeoPackage]()

_(Links to be added/updated after data set up on hosting space provided by OGC)_
