...
The http://docs.opengeospatial.org/per/17-042.html[CDB Engineering Report] (ER) summarizes the CDB sub-thread. The ERdocument is structured in three main sections and includes:
...
This Testbed 13 Engineering Report describes:
